...
!function (w, $) {
    ...
    var DateRangePicker = w.leads.DateRangePicker = function (element, options, cb) {
        ...
        if (typeof options.template == 'string') {
            this.template = Mustache.render(options.template, this);
        }
        ...
        this.container.find('.applyDiv').on('click', 'button.applyBtn', $.proxy(this.clickApply, this));
    ...
    DateRangePicker.prototype = {
        ...
        move: function () {
            ...
            if (this.opens == 'left') {
                ...
                var $left = ($(window).width() < 375) ? 5 : this.element.offset().left
                this.container.css({
                    top: this.element.offset().top + this.element.outerHeight(),
                    left: $left,
                    right: 'auto',
        ...
        show: function (e) {
            ...
            $(document).on('mousedown', $.proxy(this.close, this));
        },
