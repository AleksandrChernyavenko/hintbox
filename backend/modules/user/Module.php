...
class Module extends \yii\base\Module
{
    ...
    /**
     * @var array Model classes, e.g., ["User" => "backend\modules\user\models\User"]
     * Usage:
     *   $user = Yii::$app->getModule("user")->model("User", $config);
     *   (equivalent to)
     *   $user = new \backend\modules\user\models\User($config);
     *
    ...
    protected function getDefaultModelClasses()
    {
        ...
        return [
            ...
            'Role'       => 'backend\modules\user\models\Role',
            'UserKey'    => 'backend\modules\user\models\UserKey',
            'UserAuth'   => 'backend\modules\user\models\UserAuth',
            'ForgotForm' => 'backend\modules\user\models\forms\ForgotForm',
            'LoginForm'  => 'backend\modules\user\models\forms\LoginForm',
            'ResendForm' => 'backend\modules\user\models\forms\ResendForm',
            'UserSearch' => 'backend\modules\usermodels\search\UserSearch',
        ];
    }
