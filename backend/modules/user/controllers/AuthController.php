...
class AuthController extends Controller
{
     ...
     *
     * @param \yii\authclient\BaseClient $client
     * @return \backend\modules\user\models\UserAuth
     */
    protected function initUserAuth($client)
    {
        /** @var \backend\modules\user\models\UserAuth $userAuth */
     ...
     *
     * @param \yii\authclient\BaseClient $client
     * @param \backend\modules\user\models\UserAuth $userAuth
     */
     ...
     * revert to fallback
     *
     * @param \backend\modules\user\models\User $user
